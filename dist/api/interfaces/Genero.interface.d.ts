...
export interface IGeneroController {
    ...
    atualizar(req: Request<TRequestParams.Genero, {}, TRequestBody.Genero>, res: Response<TResponsePut | TResponseErro>): Promise<void>;
    deletar(req: Request<TRequestParams.Genero>, res: Response<TResponseDelete | TResponseErro>): Promise<void>;
}
